  ...
  return (
    <Layout showHeader={false}>
      <div className="container mx-auto p-4">
        {/* College Header - AVS Engineering College */}
        <div className="mb-6 w-full">
          <div className="flex items-center justify-between gap-2 sm:gap-4 md:gap-6 py-4">
          ...
          <div className="text-center mb-4 sm:mb-6 md:mb-8 print:mb-6 print:pt-8 print:px-8">
            ...
            <div className="flex items-center justify-between gap-2 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div className="text-center">
                    <div className="text-white font-bold text-xs leading-tight">
                      <div className="border border-white rounded p-0.5">
                        <div className="text-[6px] sm:text-[8px]">AVSEC</div>
                        <div className="text-[5px] sm:text-[6px]">Salem</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center flex-1 min-w-0">
                <div className="text-lg sm:text-2xl md:text-3xl font-bold text-foreground tracking-wide leading-tight">
                  <span className="block sm:inline">AVS</span>
                  <span className="block sm:inline sm:ml-2">ENGINEERING</span>
                  <span className="block sm:inline sm:ml-2">COLLEGE</span>
                </div>
              ...
              {/* Right Logo - NAAC Accreditation Badge */}
              <div className="w-12 h-12 sm:w-14 md:w-16 sm:h-14 md:h-16 flex-shrink-0">
                <div className="w-full h-full bg-gradient-to-br from-red-600 to-red-800 rounded-full flex items-center justify-center shadow-lg border border-yellow-400 relative">
                  {/* NAAC Badge Design */}
                  <div className="text-center text-white">
                    <div className="text-sm sm:text-base font-bold bg-yellow-500 text-red-800 rounded-full w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center mx-auto mb-0.5">
                      A
                    </div>
                    <div className="text-[5px] sm:text-[6px] font-bold leading-tight">
                      <div>NAAC</div>
                    </div>
                  </div>
                  {/* Ribbon */}
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-red-700 text-yellow-300 text-[4px] sm:text-[5px] px-0.5 rounded-t font-bold">
                    1st cycle
                  </div>
                </div>
              </div>
